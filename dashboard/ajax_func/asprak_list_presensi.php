...
require_once('../function/connect.php');
	...
	?>
		<tr>
			<td colspan="7" class="text-center"><a href='#' onClick='confirm_delete("function/presensi_hapus_asprak.php?pertemuan=<?php echo $pertemuan ?>&idj=<?php echo $id_jadwal ?>","<?php echo $row3->matkul.$row3->kelas."&nbsp;pertemuan&nbsp;".$pertemuan?>")'><i class='fa fa-trash-o fa-2x'></i></a></td>
		</tr>
<?php }
