...
<script>
	$(document).ready(function(){
		$('#jadwal').change(function(){
			...
			$.ajax({
				url:"ajax_func/admin_pilih_pertemuan.php?idj="+jadwal,
				type:"GET",
				dataType:"html",
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   Daftar presensi
			   	...
			   	<a href='admin_presensi_tambah.php'  style="float: right;" ><i class='fa fa-plus-square fa-2x' data-target="#ModalAdd" data-toggle="modal"></i></a>
...
<!-- <script src="assets/js/jQuery-2.1.4.min.js" type="text/javascript"></script> -->
	...
	<script>
		function set(pertemuan,idj,nim){
				$.ajax({
					url: "admin_presensi_edit.php?nim="+nim+"&idj="+idj+"&pertemuan="+pertemuan,
					type: "GET",
					dataType:"html",
					success: function (data){
					$("#ModalEdit").html(data);
