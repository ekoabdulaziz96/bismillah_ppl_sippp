...
<script>
	$(document).ready(function(){
		$('#penunjang').change(function(){
			...
			$.ajax({
				url:"ajax_func/admin_list_penunjang.php?penunjang="+penunjang,
				type:"GET",
				dataType:"html",
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   Daftar Penunjang
			   	...
			   	<a href='admin_penunjang_tambah.php'  style="float: right;" ><i class='fa fa-plus-square fa-2x' ></i></a>
...
<!-- <script src="assets/js/jQuery-2.1.4.min.js" type="text/javascript"></script> -->
	...
	<script>
		function set(idp){
				$.ajax({
					url: "admin_penunjang_edit.php?idp="+idp+"&th=<?php echo $th ?>&sems=<?php echo $sems ?>",
					type: "GET",
					dataType:"html",
					success: function (data){
					$("#ModalEdit").html(data);
