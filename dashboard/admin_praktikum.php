...
<script>
	$(document).ready(function(){
		$('#praktikum').change(function(){
				var praktikum= $("#praktikum").val();	
			$.ajax({
				url:"ajax_func/admin_pilih_status.php?idj="+praktikum,
				type:"GET",
				dataType:"html",
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="col-md-5 col-sm-8 col-xs-12">
					Mata Kuliah | Kelas :
				<select class='form-control' id='praktikum'>
				...
				<div class="col-md-2 col-sm-4 col-xs-12" id="hasil_status">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   Daftar praktikum
			   	...
			   	<a href='admin_praktikum_tambah.php'  style="float: right;" ><i class='fa fa-plus-square fa-2x' data-target="#ModalAdd" data-toggle="modal"></i></a>
...
<!-- <script src="assets/js/jQuery-2.1.4.min.js" type="text/javascript"></script> -->
	...
	<script>
		function set(nim,idj){
				$.ajax({
					url: "admin_praktikum_edit.php?nim="+nim+"&idj="+idj+"&th=<?php echo $th ?>&sems=<?php echo $sems ?>",
					type: "GET",
					dataType:"html",
					success: function (data){
					$("#ModalEdit").html(data);
