...
<script>
	$(document).ready(function(){
		$('#pertemuan').change(function(){
				...
				// var pertemuan= $("#pertemuan").val();		
			$.ajax({
				url:"ajax_func/praktikan_list_presensi.php?idj=<?php echo $kepentingan ?>&status=asprak&pertemuan="+pertemuan,
				type:"GET",
				dataType:"html",
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<?php
					$idj = $_GET['idj'];
					$result1 = $con->query("SELECT * FROM presensi where id_praktikum in (SELECT id_praktikum FROM praktikum where id_jadwal = '$kepentingan' and status ='asprak' )group by pertemuan");
					// Execute the query
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   Daftar presensi Praktikan
			   	...
			   	<a href='praktikan_presensi_tambah.php?akhir=<?php echo $timeAkhir ?>'  style="float: right;" ><i class='fa fa-plus-square fa-2x' data-target="#ModalAdd" data-toggle="modal"></i></a>
...
<!-- <script src="assets/js/jQuery-2.1.4.min.js" type="text/javascript"></script> -->
	...
	<script>
		function set(pertemuan,idj,nim){
				$.ajax({
					url: "praktikan_presensi_edit.php?nim="+nim+"&idj="+idj+"&pertemuan="+pertemuan,
					type: "GET",
					dataType:"html",
					success: function (data){
					$("#ModalEdit").html(data);
