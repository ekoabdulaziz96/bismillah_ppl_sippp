		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   Tambah Presensi Praktikum
			   	...
			   	<a href='asprak_presensi.php'  style="float: right;" ><i class='fa  fa-arrow-circle-o-left fa-2x' data-target="#ModalAdd" data-toggle="modal"></i></a>
			   	
			  
			</div>
			<form action="function/presensi_tambah_asprak.php?idj=<?php echo $kepentingan ?>" name="modal_popup" enctype="multipart/form-data" method="post">
				             ...
				             <div class="form-group">
				              ...
				              <div class="form-group" id="hasil_pertemuan">
								...
								while ($i <= $row1->max_prak) { 
									$result2 = $con->query("SELECT * FROM presensi where pertemuan='$i' and id_praktikum in (select id_praktikum from praktikum where id_jadwal='$kepentingan'  and status ='praktikan') group by pertemuan");
				              ...
				              <div>
								 ...
								 <input class="form-control" type="text" name="status" id="status" value="<?php echo 'praktikan' ?>" readonly='yes'>
							</div>
